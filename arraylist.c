...
int al_add(ArrayList* this, void* pElement)
{
    ...
    {
        //Los parentesis pueden no estar
        *((this->pElements)+(this->size)) = pElement;
        //this[this->size].pElement = pElement;
        this->size++;
...
int al_sort(ArrayList* this, int (*pFunc)(void*,void*), int order)
{
    ...
    if(this != NULL && (*pFunc)!= NULL)
    {
        ...
        for(i=1; i<al_len(this); i++)
        {
            ...
            while(j >= 0 && order == pFunc(aux, *(this->pElements+j))) // temp<data[j] o temp>data[j]
            {
...
ArrayList* al_filter(ArrayList* listIn, int (*functionFilter)(void*))
{
    ...
    if(listIn != NULL && functionFilter != NULL)
    {
        ...
        {
            element = al_get(listIn, i);
            if(functionFilter(element)==1)
            {
                al_add(list, element);
            }
        }
